...
export const Hero: React.FC<HeroProps> = ({}) => {
    return(
        <>
            <div className="h-[48vh] lg:h-[55vh] bg-[#EFEFEF] p-2 hidden md:flex justify-start bg-no-repeat bg-auto"
                 style={{
            ...
            >
                <div className="container my-52 lg:m-auto hidden md:flex">
                    <div className="flex flex-col my-auto w-fit rounded-2xl bg-[#e1edff] p-6 shadow-xl opacity-80"
                         data-aos="zoom-in"
            ...
            <div className="h-[48vh] relative md:hidden lg:h-[55vh] bg-[#EFEFEF] p-2 flex justify-center bg-no-repeat bg-auto"
                 style={{
                     backgroundImage: "url('/img/home/hero.webp')",
            ...
            >
                <div className="container my-52 lg:m-auto hidden md:flex">
                    <div className="flex flex-col my-auto w-fit rounded-2xl bg-[#e1edff] p-6 shadow-xl opacity-80">
                        <Image src={'/img/home/Fiosioste_Font.webp'} width="200px" height="47px" layout="fixed" alt="Fisioste Logo"/>
                        <hr className="border border-secondary w-[100px] mt-6"/>
                        <p className="mt-6 font-light text-xl">Un team di esperti al <span className="text-secondary">vostro servizio</span></p>
                        <div className="flex flex-col mt-6">
                            <Link href="/chiSiamo">
                                <button className='px-8 py-3 rounded-full w-full mb-4 bg-primary text-white sm:mr-7 hover:opacity-80'>SCOPRI DI PIU</button>
