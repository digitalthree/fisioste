        ...
        <div className="grid grid-cols-2 mt-10 lg:mt-0 md:grid-cols-4 gap-4">
            ...
            >
                ...
                <div className="flex flex-col text-center">
                    ...
                    <a href="tel:+39 3288349050" className="text-secondary text-base xl:text-[18px] font-light hover:cursor-pointer hover:underline">+39 3288349050 </a>
                </div>
            </div>
            <div className="flex flex-col items-center md:border-r md:border-gray-200"
                 data-aos="fade-down"
            ...
            >
                ...
                <div className="flex flex-col text-center">
                    ...
                    <a href="tel:+39 3288349050" className="text-secondary text-base xl:text-[18px] font-light hover:cursor-pointer hover:underline">info@fisioste.it</a>
                </div>
            </div>
            <div className="flex flex-col items-center md:border-r md:border-gray-200"
                 data-aos="fade-down"
            ...
            >
                ...
                <div className="flex flex-col text-center">
                    ...
                    <a className="text-secondary text-center text-base xl:text-[18px] font-light hover:underline" rel="noreferrer"
            ...
            >
                ...
                <div className="flex flex-col text-center">
                    ...
                    <a className="text-secondary text-base xl:text-[18px] font-light hover:underline" rel="noreferrer"
                       target="_blank" href="https://g.page/Fisioste?share">Lun-Ven / 9:00 - 19:00</a>
                </div>
            </div>
        </div>
    )
