    ...
    return(
        <>
            <div className="container m-auto py-10">
                <h1 className="text-secondary">Privacy Policy di www.fisioste.it</h1>
                ...
                <h2 className="text-secondary text-[25px] mb-2 mt-8">Titolare del Trattamento dei Dati</h2>

                fisioste - Viale della Resistenza, 29 64100 Teramo
                <br/>
                Indirizzo email del Titolare: info@fisioste.it

                <h2 className="text-secondary text-[25px] mb-2 mt-8">Tipologie di Dati raccolti</h2>
                ...
                <h2 className="text-secondary text-[20px] mt-2">Modalità di trattamento</h2>
                ...
                <h2 className="text-secondary text-[20px] mt-2">Base giuridica del trattamento</h2>
                ...
                <h2 className="text-secondary text-[20px] mt-2">Luogo</h2>
                ...
                <h2 className="text-secondary text-[20px] mt-2">Periodo di conservazione</h2>
                ...
                <h2 className="text-secondary text-[20px] mt-2">Dettagli sul diritto di opposizione</h2>

                Quando i Dati Personali sono trattati nell’interesse pubblico, nell’esercizio di pubblici poteri di cui è investito il Titolare oppure per perseguire un interesse legittimo del Titolare, gli Utenti hanno diritto ad opporsi al trattamento per motivi connessi alla loro situazione particolare.

                Si fa presente agli Utenti che, ove i loro Dati fossero trattati con finalità di marketing diretto, possono opporsi al trattamento senza fornire alcuna motivazione. Per scoprire se il Titolare tratti dati con finalità di marketing diretto gli Utenti possono fare riferimento alle rispettive sezioni di questo documento.

                <h2 className="text-secondary text-[20px] mt-2">Come esercitare i diritti</h2>


                Per esercitare i diritti dell’Utente, gli Utenti possono indirizzare una richiesta agli estremi di contatto del Titolare indicati in questo documento. Le richieste sono depositate a titolo gratuito e evase dal Titolare nel più breve tempo possibile, in ogni caso entro un mese.

                <h2 className="text-secondary text-[25px] mb-2 mt-8">Ulteriori informazioni sul trattamento</h2>
                ...
                <h2 className="text-secondary text-[20px] mt-2">Informazioni non contenute in questa policy</h2>
